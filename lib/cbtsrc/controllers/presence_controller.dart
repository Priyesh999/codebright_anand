...
class PresenceController extends GetxController {
  ...
  presence() async {
    ...
    // if (!determinePosition["error"]) {
      ...
      // GeoData placemarks = await Geocoder2.getDataFromCoordinates(
      //     latitude: position.latitude,
      //     longitude: position.longitude,
      //     googleMapApiKey: "GOOGLE_MAP_API_KEY");
      // List<Placemark> placemarks = await placemarkFromCoordinates(position.latitude, position.longitude);
      // String address = "${placemarks.streetNumber}, ${placemarks.address}, ${placemarks.city}";
      // double distance = Geolocator.distanceBetween(0.0, 0.0, position.latitude, position.longitude);
