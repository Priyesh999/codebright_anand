...
class ScannedViewer extends StatefulWidget {
  String vcbTechModel;
  String title;
  String description;
...
class _YoutubeViewerState extends State<ScannedViewer> {
  ...
  void initState() {
    ...
    _controller = YoutubePlayerController(
      initialVideoId: vcbTechModel.split("/").last,
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  //     if (vcbTechModel.data!.prVideoData![index]!.prChapterId !=
                  //         vcbTechModel.data!.prVideoData![isPosition.value]!
                  //             .prChapterId) {
                  //       return InkWell(
                  //         onTap: () {
                  //           setState(() {
                  ...
                  //                       child: CBTTextNew(
                  //                         vcbTechModel.data!.prVideoData![index]
                  //                             .prName!,
                  //                         style: TStyle.f16_B
